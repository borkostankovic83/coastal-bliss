...
<?php
 ...
 $manicure_services = [
     [
         ...
         "services" => [
             ["The Coastal Bliss Manicure", "$45 (Classic Spa Manicure) – A timeless treatment for beautifully groomed hands. Includes nail shaping, a warm hand soak, cuticle care, sugar scrub, warm towel wrap, and a deeply soothing hand massage."],
             ["The Luxe Gel Manicure", "$55 – A flawless, chip-resistant finish with expert nail shaping, detailed cuticle care, and strengthening gel polish for a glossy, long-lasting effect."],
             ["European Precision Gel Manicure", "$65 – A refined manicure using European e-file technique for meticulous cuticle care and a polished, long-lasting gel finish."],
         ]
     ]
 ];
 ...
 $pedicure_services = [
     [
         ...
         "services" => [
             ["The Coastal Bliss Pedicure", "$75 (Classic Spa Pedicure) – A rejuvenating pedicure with a warm foot soak, nail and cuticle care, exfoliation, relaxing foot massage, and polish application."],
             ["The Luxe Gel Pedicure", "$85 – A refined, long-lasting pedicure with a gel polish application for a flawless, chip-free finish and a hydrating foot massage."],
         ]
     ]
 ];
 ...
 $custom_services = [
     [
         ...
         "services" => [
             ...
             ["Hot Stone Massage", "$20 – Experience deep relaxation with warm basalt stones during your hand or foot massage."],
             ["CBD & Peppermint Crème", "$20 – A soothing, anti-inflammatory treatment to hydrate and calm tired hands and feet."],

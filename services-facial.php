...
<?php
 ...
 $services = [
     [
         ...
         "services" => [
             ...
             ["Ultimate Bliss Back Facial", "Indulge in a luxurious full-back experience that melts away tension while deeply revitalizing the skin. This back facial includes an organic double cleanse, gentle exfoliation with fruit enzymes, steam, extractions (if needed), and a nourishing botanical masque to soften and refresh the skin. Includes a nourishing warm oil massage to enhance relaxation and restore a silky-smooth feel. Finished with a rich Eminence moisturizer to lock in hydration and glow."],
         ]
     ],
     [
         "title" => "Platinum Coastal Bliss Facial",
         "price" => "$195 (75 min)",
         "services" => [["Dermaplaning Facial","A luxurious resurfacing facial that removes dead skin cells and peach fuzz for a smooth, radiant complexion. Includes deep cleansing, dermaplaning, an Eminence masque, and organic finishing serums."],]
     ],
     [
         ...
         "services" => [
             ...
             ["Hot Stone", "Warm stones are gently massaged over the face to promote circulation, relaxation, and deeper muscle release."],
 ...
 <section id="services" class="py-5" style="color: #222; background-color: #FAFAFA;">
     <div class="container">
         ...
         <img src="images/eminence-logo.png" alt="Image" style="display: block; margin: 20px auto; max-width: 100%; height: auto;">
         <?php foreach ($services as $service) : ?>
             <div class="mb-5" style="padding-bottom: 20px; border-bottom: 2px solid #665d34;">
                 ...
                 <?php endif; ?>
                 <p style="color: #333; font-size: 1.5em; line-height: 1.5; margin-bottom: 15px;"> <?= $service["description"] ?? "" ?> </p>

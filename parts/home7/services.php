<section class="service-section-home7" id="services">
    ...
    <div class="row">
      ...
      <div class="col-lg-6">
        <div class="about-style-home7">
          <div class="thumb"><img src="images/resource/about7-1.jpg" alt=""></div>
          <div class="about-content">
            <h4 class="title">Makeover Now</h4>
            <p class="text">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
            <a href="page-contact.php" class="theme-btn btn-style-one mt-10">APPPOINMENT NOW</a>
          </div>
        </div>
      </div>
    </div>

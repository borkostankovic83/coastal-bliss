				...
				<div class="inner-container">
					<div class="top-left">
						...
						<ul class="list-style-one">
							<li><a href="mailto:lawson@example.com">ألما لوسون@شركة.كوم</a></li>
						</ul>
					</div>

					<div class="top-right">
						<ul class="list-style-two">
							<li>من الإثنين إلى السبت: ٩:٠٠أكون – ٦:٠٠مساءً شمس: <a class="active" href="#">مغلق</a></li>
						</ul>
				...
				<div class="main-box">
					...
					<div class="nav-outer">
						<nav class="nav main-menu">
							<?php
								$default_menu_file = "parts/header/menu-rtl.php";
					...
					<div class="outer-box">
						...
						<!-- Button -->
						<div class="btn-box">
							<a href="page-contact.php" class="theme-btn btn-style-one"><span class="btn-title">احجز الآن</span></a>
						</div>

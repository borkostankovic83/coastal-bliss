...
<div class="page-wrapper home4-style">
	<?php require_once('parts/preloader.php'); ?>
    <!-- Main Header-->
    <header class="main-header header-style-four" id="home">
        <div class="outer-box">
                ...
                <div class="main-box">
                    ...
                    <div class="outer-box">
                        ...
                        <div class="btn-box d-none d-xl-block">
                            <a href="page-contact.php" class="theme-btn btn-style-transparent"><span class="btn-title">Book Now</span></a>
                        </div>

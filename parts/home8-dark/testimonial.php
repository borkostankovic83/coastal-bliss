<section class="testimonial-section style-three">
  <div class="bg bg-image" style="background-image: url(./images/background/bg-testimonial1.png)"></div>
  <div class="instagram1-7 bounce-y"></div>
  <div class="testimonial-pattrn1-2 bounce-x"></div>

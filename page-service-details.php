<?php 
    $head_title="Purerelax | Spa & Beauty PHP Template | Service Details";
?>
				...
				<div class="service-sidebar">
					...
					<div class="sidebar-widget service-sidebar-single">
						...
						<div class="sidebar-service-list">
							<ul>
								<li><a href="page-service-details.php" class="current"><i class="fas fa-angle-right"></i><span>Deep Massage</span></a></li>
								<li class="current"><a href="page-service-details.php"><i class="fas fa-angle-right"></i><span>Facial Treatments</span></a></li>
								<li><a href="page-service-details.php"><i class="fas fa-angle-right"></i><span>Body Treatments</span></a></li>
								<li><a href="page-service-details.php"><i class="fas fa-angle-right"></i><span>Nail Care</span></a></li>
								<li><a href="page-service-details.php"><i class="fas fa-angle-right"></i><span>Body Glow & Wraps</span></a></li>
								<li><a href="page-service-details.php"><i class="fas fa-angle-right"></i><span>Hair Salon</span></a></li>
							</ul>
						</div>
